...
const Blogs = () => (
    <>
        ...
        <div className="flex flex-col space-y-8 mt-5 sm:ml-12">
                <div className="flex flex-row space-x-10 sm:space-x-64">
                ...
                <div className="flex flex-row space-x-10 sm:space-x-44">
                ...
                <div className="flex flex-row space-x-10 sm:space-x-48">
